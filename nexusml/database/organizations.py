...
class OrganizationDB(Entity):
    ...
    users = db.relationship('UserDB', backref='users', cascade='all, delete-orphan', lazy='dynamic')
...
class UserDB(Entity):
    ...
    def organization_id(cls):
        return Column(MEDIUMINT(unsigned=True),
                      ForeignKey(OrganizationDB.organization_id, ondelete='CASCADE'), nullable=True)
